...
| Market cap | FMP Profile / Market Cap; or calculate from Databento | FMP: `/stable/profile?symbol={symbol}` or `/stable/market-capitalization?symbol={symbol}`; Databento: close price × `shares_outstanding`         |
